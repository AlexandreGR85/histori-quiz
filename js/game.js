	...
	function requete(){
		...
		request.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementsByClassName('imagequestion')[0]['src'] = "/Projet_Pro/uploads/quizImg/" + phpArray['questions']['Pictures'];
				document.getElementsByClassName('imagequestion')[1]['src'] = "/Projet_Pro/uploads/quizImg/" + phpArray['questions']['Pictures'];
